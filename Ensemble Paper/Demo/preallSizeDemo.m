...
% Changed the mean vals to multiply by PPD
...
for i=1:numTrials;
    trialsDotAmountSize(i)=dotAmount;
end
...
for h=1:meanNoiseCount
    for i=1:numTrials
        dotSizeNoise=[];
        dotSizeNoise=randn(1,trialsDotAmountSize(i));
...
for i=1:numTrials
    dotSizeClear=[];
    dotSizeClear=randn(1,trialsDotAmountSize(i));
...
save(datafile,'rect', 'PPD', 'filterList', 'nFilter', 'startList', 'nStart', 'nTrials', 'iterationList', 'nIteration', ...
    'trialsDotAmountSize', 'trialsDotSizeNoiseMean', 'trialsDotSizeClearMean', 'trialsDotSizeClearVariance', 'trialsDotSizeNoiseVariance',...
