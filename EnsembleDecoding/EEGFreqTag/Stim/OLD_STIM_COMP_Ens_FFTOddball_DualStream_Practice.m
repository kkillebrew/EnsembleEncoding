function [rawdataPractice] = Ens_FFTOddball_DualStream_Practice(rect,w,button1,button2,button3,button4,xc,yc,PPD,dev_id,hz,dirAttend)
...
trialOrder(:,4) = zeros([20,1])+dirAttend;
