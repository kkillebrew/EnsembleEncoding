...
% datadirBehavioral = '/Volumes/clab/Google Drive/Lab Projects/Today''s Stuff/Dissertation Stuff/Experiments/Behavioral/Data/';
datadirBehavioral = '/Volumes/clab/Google Drive/Lab Projects/Today''s Stuff/Dissertation Stuff/Experiments/Behavioral/Data/';
...
% datadirFreqTag = '/Volumes/clab/Google Drive/Lab Projects/Today''s Stuff/Dissertation Stuff/Experiments/EEG Freq Tag/Data/';
datadirFreqTag = '/Volumes/clab/Google Drive/Lab Projects/Today''s Stuff/Dissertation Stuff/Experiments/EEG Freq Tag/Data/';
...
%% VEP variables
datadirVEP = '/Volumes/clab/Google Drive/Lab Projects/Today''s Stuff/Dissertation Stuff/Experiments/EEG VEP/Data/';
...
datadirfMRI = '/Volumes/clab/Google Drive/Lab Projects/Today''s Stuff/Dissertation Stuff/Experiments/MRI Adaptation/Data/';
...
elseif strcmp(dataType,'VEPBehav') ||  strcmp(dataType,'VEPEEG') || strcmp(dataType,'LoadVEP') || strcmp(dataType,'VEPFake')
    ...
    elseif strcmp(dataType,'VEPEEG')
        ...
        if length(subjid)==2
            firstLetter = charEEGVEPList(:,1);
            secondLetter = charEEGVEPList(:,2);
            subjLocIdx(:,1) = subjid(1) == firstLetter;
            subjLocIdx(:,2) = subjid(2) == secondLetter;
            subjIdx = find(subjLocIdx(:,2)==1 & subjLocIdx(:,1)==1);
        elseif length(subjid)==3
