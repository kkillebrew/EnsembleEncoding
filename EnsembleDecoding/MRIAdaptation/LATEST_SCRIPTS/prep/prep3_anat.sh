...
if ($manual_nudge) then
	...
	set curanat = ${curanat}_obl
       ...
       # align centers of EPI and Anatomical (to help with alignment of data from different scanners)
    @Align_Centers \
	-base  ${EPI_for_align}+orig \
	-dset ${SUBJ}${curanat}+orig
    set curanat = ${curanat}_shft # check name of output file and set correct name here
