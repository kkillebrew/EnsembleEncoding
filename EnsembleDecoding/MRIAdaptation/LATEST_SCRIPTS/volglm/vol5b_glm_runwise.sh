...
#
# This script will execute a volume-based GLM using 3dDeconvolve or 3dREMLfit,
...
foreach run ($ALLRUNS)
    ...
    set output_prefix = ${SUBJ}_${run}${curfunc}_bucket; # do NOT include +orig or _REML tag
    set output = ${output_prefix}${REMLtag}+orig; # add _REML via $REMLtag, if desired
