...
elseif crashReload == 0
    ...
    % Recalculate rect to be 90% of current screen to scale for ROIs
    holderRect = rect;
    rect(2) = rect(2)+(rect(4)-(rect(4)*.9))/2;   % Amount to subtract/add from top/bottom and left/right
    rect(4) = rect(4)-(rect(4)-(rect(4)*.9))/2;
