...
fmriComp = 1;
buttonBox = 0;
crashReload = 1;   % IF you need to restart after crash
...
%     currRun = currRun+1;
    ...
    save(sprintf('%s',datadir,'redoFirstRun_',datafile),'rawdata','trialOrder','runStartTime','instructionStartTime','ibiStartTime','blockStartTime','trialStartTime','responseStartTime','responseEndTime','runEndTime');
    % Save all data after each run in case of crash
    save(sprintf('%s',datadir,'redoFirstRun_',datafile_full));
end
