...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if trialOrder(n,2)==1 % Variance Experiment
        ...
        varIdx=stepCount(2,filterIdx,iterationIdx,startIdx);    % stepCount list for variance
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        startVal=startList(startIdx);
        rawdata(n,3)=startVal;
        compareMeanIdx=stepCount(1,filterIdx,iterationIdx,startIdx);    % stepCount list for mean
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    while 1
        ...
        if rawdata(n,5)==1;   % noisy came first
            if keycode(buttonA)
                rawdata(n,7)=1;   % noise more variable/larger
                break
            end
            if keycode(buttonK)
                rawdata(n,7)=2;   % clear more variable/larger
                break
            end
        else    % clear came first
            if keycode(buttonA)
    ...
    % noise=1 clear=2
    if rawdata(n,7)==2    % choose that test was more variable
        if prevAns(trialOrder(n,2),filterIdx,iterationIdx,startIdx)==2   % States that on the last trial, ref had greater variablity
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    this_b = 0;
    for b = break_trials
        if n==round(b*length(variableListVariance*2))
            this_b = b;
            break
        end
    end
