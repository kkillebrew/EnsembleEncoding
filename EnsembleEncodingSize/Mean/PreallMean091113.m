...
edgeBufferX=(rect(3)-((4*((meanNoise(meanNoiseCount)*PPD)+10)+dotBuffer)*2))/2;
edgeBufferY=(rect(4)-((4*((meanNoise(meanNoiseCount)*PPD)+10)+dotBuffer)*2))/2;
...
save(datafile,'filterList', 'rect', 'meanNoise', 'startList', 'nStart','meanNoiseCount', 'nCompareMean', 'compareMeanList','nTrials','PPD', 'nFilter', 'iterationList', 'nIteration', 'stdev','numTrials','trialsDotAmount','trialsDotSizeNoise','trialsXTopNoise','trialsYTopNoise','trialsXBotNoise','trialsYBotNoise','noiseMatrix','destRect');
